...
<div class="row">
    ...
    <h3 style="color: #666" ><?php echo ('Mis documentos'); ?></h3>
    ...
    <div class="panel panel-primary filterable">
        ...
        <div class="table-responsive">
            <table class="table table-striped">
                <thead>
                    <tr class="filters">                        
                        <th><?php echo $this->Paginator->sort('name', '<input type="text" class="form-control input" placeholder="Nombre Documento" disabled>', array('escape' => false)); ?></th>
                ...
                <tbody>
                    ...
                    <?php foreach ($datos as $dato): ?>
                        <tr>  
                            ...
                            <td >
                                <?php echo $this->Html->link(__( $this->Html->image("estadistica2.png",array('data-toggle'=>"tooltip", 'data-placement'=>"left", 'title'=>"Editar informacion",'style'=>'height:1.2em;'))), array('action' => 'view', $dato['Dato']['id']), array('escape' => false)); ?>
                            </td>
                           <td >
                                <?php echo $this->Html->link(__('<span class="glyphicon glyphicon-pencil"  data-toggle="tooltip" data-placement="left" title="Editar informacion"></span>'), array('action' => 'edit',  $dato['Dato']['id']), array('escape' => false,'id'=>'col')); ?>
                            </td>
                            	
                            <td > 
                                <?php echo $this->Form->postLink(__('<span class="glyphicon glyphicon-trash" data-toggle="tooltip" data-placement="left" title="Desactivar usuario"></span>'), array('action' => 'delete', $dato['Dato']['id']),  array('escape' => false, 'id' => "cole"), __('Esta seguro de eliminar el archivo %s?', $dato['Dato']['name'])); ?>
                            </td>	
