 <?php App::uses('Controller', 'UsersController');  ?>
 <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">            
            ...
            <div class="navbar-header">
             ...
             ?>
                <?php  
                    echo $this->Html->image("LOGO.svg", array('style'=>' height: 3em; margin: 0.5em 0 0 0;',
                "alt" => "Sippreas",
                'url' => array('controller'=>'pages','action' => 'home2', $userGroup=>false)
                ));?>
