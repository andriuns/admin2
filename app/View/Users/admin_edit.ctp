...
<div class="row"> 
    ...
    <div class=" col-xs-12 col-md-3 "> 
        ...
        <div id="edid"style="padding-bottom: 1.5em; padding-top:10em; margin-left: -15px; margin-right: -15px "></div>
    ...
    <div class="col-xs-12 col-sm-6 col-md-9">
        <div style="margin-bottom: 1.5em;">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">                
                    ...
                    <li class="divider"></li>
                    <li><?php echo $this->Html->link('<span class="glyphicon glyphicon-trash"></span>' . ' ' . 'Eliminar usuario', array('action' => 'delete', $this->Form->value('User.id')), array('confirm' => 'Esta seguro de eliminar la cuenta?', 'escape' => false)) ?></li>
                    <li class="divider"></li>
        ...
        <fieldset>
            ...
            <?php
            echo $this->Form->input('password', array('class' => 'form-control', 'placeholder' => 'Nueva contaceña', 'value' => '','data-toggle'=>"tooltip", 'data-placement'=>"left" ,'title'=>"Entre 5 y 15 caracteres",
