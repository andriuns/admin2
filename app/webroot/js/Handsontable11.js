  ...
  function ContextMenu(instance, customOptions){
    ...
    this.defaultOptions = {
      items: {
        ...
        'col_left': {
          name: 'Insertar col a la izquierda',
          callback: function(key, selection){
        ...
        'col_right': {
          name: 'Insertar col a la derecha',
          callback: function(key, selection){
        ...
        'make_read_only': {
          name: function() {
            ...
            if(!atLeastOneReadOnly) {
              return "Hacer solo lectura";
            } else {
              return "Hacer editable";
            }
          },
          callback: function() {
            var atLeastOneReadOnly = contextMenu.checkSelectionReadOnlyConsistency(this);
        ...
        'horizontal_alignment': {
          name: function () {
            var div = document.createElement('div'),
              ...
              lText = document.createTextNode('izqu'),
              cText = document.createTextNode('cen'),
              rText = document.createTextNode('Dere'),
              jText = document.createTextNode('just');
        ...
        'vertical_alignment': {
          name: function () {
            var div = document.createElement('div'),
              ...
              tText = document.createTextNode('arriba'),
              mText = document.createTextNode('Medio'),
              bText = document.createTextNode('abajo');
  ...
  addCommentsActionsToContextMenu = function (defaultOptions) {
    ...
    defaultOptions.items.commentsAddEdit = {
      name: function () {
        ...
        return hasComment ? "Editar Comment" : "Agregar Comment";
